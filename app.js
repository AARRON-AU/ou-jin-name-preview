const candidates = [
  ...
  { char: '承', group: '金', jyutping: 'Sing4', bazi: 28, meaning: 28, sound: 26, brother: 0, meaningText: '承有承担、承继与担当之意，传统姓名学常作金性参考。', soundText: 'Au1 Zeon3 Sing4：尾音温厚，整体端正。', brotherText: '暂未发现与“恺”构成的自然正向词语。' },
  { char: '昌', group: '金', jyutping: 'Coeng1', bazi: 27, meaning: 27, sound: 27, brother: 0, meaningText: '昌有昌盛、光明与兴旺之意，传统姓名学常作金性参考。', soundText: 'Au1 Zeon3 Coeng1：高平调明亮，叫名清朗。', brotherText: '暂未发现与“恺”构成的自然正向词语。' },
  { char: '常', group: '金', jyutping: 'Soeng4', bazi: 27, meaning: 25, sound: 26, brother: 0, meaningText: '常有恒常、安定与持守之意，传统姓名学常作金性参考。', soundText: 'Au1 Zeon3 Soeng4：长元音舒展，音律平稳。', brotherText: '暂未发现与“恺”构成的自然正向词语。' },
  ...
  { char: '先', group: '金', jyutping: 'Sin1', bazi: 27, meaning: 25, sound: 26, brother: 0, meaningText: '先有先见、领先与先声之意，传统姓名学常作金性参考。', soundText: 'Au1 Zeon3 Sin1：高平调清晰，叫名轻快。', brotherText: '暂未发现与“恺”构成的自然正向词语。' },
  { char: '素', group: '金', jyutping: 'Sou3', bazi: 27, meaning: 26, sound: 26, brother: 0, meaningText: '素有质朴、纯净与本真之意，传统姓名学常作金性参考。', soundText: 'Au1 Zeon3 Sou3：元音开阔，收尾自然。', brotherText: '暂未发现与“恺”构成的自然正向词语。' },
  { char: '绍', group: '金', jyutping: 'Siu6', bazi: 27, meaning: 26, sound: 25, brother: 0, meaningText: '绍有承续、介绍与发扬之意，传统姓名学常作金性参考。', soundText: 'Au1 Zeon3 Siu6：尾调下落，读感干净。', brotherText: '暂未发现与“恺”构成的自然正向词语。' },
  { char: '舒', group: '金', jyutping: 'Syu1', bazi: 27, meaning: 28, sound: 26, brother: 0, meaningText: '舒有舒展、从容与和悦之意，传统姓名学常作金性参考。', soundText: 'Au1 Zeon3 Syu1：圆唇高平，音色温润。', brotherText: '暂未发现与“恺”构成的自然正向词语。' },
  { char: '尚', group: '金', jyutping: 'Soeng6', bazi: 27, meaning: 26, sound: 25, brother: 0, meaningText: '尚有崇尚、高尚与进取之意，传统姓名学常作金性参考。', soundText: 'Au1 Zeon3 Soeng6：鼻尾沉稳，气质利落。', brotherText: '暂未发现与“恺”构成的自然正向词语。' },
  { char: '善', group: '金', jyutping: 'Sin6', bazi: 27, meaning: 28, sound: 25, brother: 0, meaningText: '善有善良、完善与仁厚之意，传统姓名学常作金性参考。', soundText: 'Au1 Zeon3 Sin6：尾调稳重，整体端庄。', brotherText: '暂未发现与“恺”构成的自然正向词语。' },
  { char: '睿', group: '金', jyutping: 'Jeoi6', bazi: 28, meaning: 29, sound: 25, brother: 0, meaningText: '睿有睿智、明察与通达之意，传统姓名学常作金性参考。', soundText: 'Au1 Zeon3 Jeoi6：尾音圆润，听感清雅。', brotherText: '暂未发现与“恺”构成的自然正向词语。' },
  { char: '胜', group: '金', jyutping: 'Sing3', bazi: 27, meaning: 27, sound: 26, brother: 0, meaningText: '胜有胜任、胜意与进取之意，传统姓名学常作金性参考。', soundText: 'Au1 Zeon3 Sing3：收尾有力，读感明快。', brotherText: '暂未发现与“恺”构成的自然正向词语。' },
  { char: '朝', group: '金', jyutping: 'Ziu1', bazi: 27, meaning: 26, sound: 26, brother: 0, meaningText: '朝有朝阳、朝气与方向之意，传统姓名学常作金性参考。', soundText: 'Au1 Zeon3 Ziu1：高平调明亮，叫名清楚。', brotherText: '暂未发现与“恺”构成的自然正向词语。' },
  { char: '修', group: '金', jyutping: 'Sau1', bazi: 27, meaning: 28, sound: 25, brother: 0, meaningText: '修有修身、修为与完善之意，传统姓名学常作金性参考。', soundText: 'Au1 Zeon3 Sau1：高平调柔和，整体斯文。', brotherText: '暂未发现与“恺”构成的自然正向词语。' },
  ...
  { char: '恒', group: '水', jyutping: 'Hang4', bazi: 28, meaning: 27, sound: 25, brother: 0, meaningText: '恒有恒心、持久与稳定之意，传统姓名学常作水性参考。', soundText: 'Au1 Zeon3 Hang4：鼻尾沉着，读感可靠。', brotherText: '暂未发现与“恺”构成的自然正向词语。' },
  { char: '鸿', group: '水', jyutping: 'Hung4', bazi: 29, meaning: 28, sound: 26, brother: 0, meaningText: '鸿有鸿鹄、广大与远志之意，传统姓名学常作水性参考。', soundText: 'Au1 Zeon3 Hung4：鼻尾饱满，气质大方。', brotherText: '暂未发现与“恺”构成的自然正向词语。' },
  { char: '宏', group: '水', jyutping: 'Wang4', bazi: 28, meaning: 28, sound: 26, brother: 0, meaningText: '宏有宏大、宽广与气度之意，传统姓名学常作水性参考。', soundText: 'Au1 Zeon3 Wang4：尾音舒展，整体稳重。', brotherText: '暂未发现与“恺”构成的自然正向词语。' },
  { char: '博', group: '水', jyutping: 'Bok3', bazi: 28, meaning: 29, sound: 25, brother: 0, meaningText: '博有博学、广博与包容之意，传统姓名学常作水性参考。', soundText: 'Au1 Zeon3 Bok3：入声收尾，清楚有力。', brotherText: '暂未发现与“恺”构成的自然正向词语。' },
  { char: '凡', group: '水', jyutping: 'Faan4', bazi: 27, meaning: 25, sound: 26, brother: 0, meaningText: '凡有平实、包容与不凡之意，传统姓名学常作水性参考。', soundText: 'Au1 Zeon3 Faan4：长元音舒展，声音温厚。', brotherText: '暂未发现与“恺”构成的自然正向词语。' },
  { char: '方', group: '水', jyutping: 'Fong1', bazi: 27, meaning: 26, sound: 26, brother: 0, meaningText: '方有方正、方向与格局之意，传统姓名学常作水性参考。', soundText: 'Au1 Zeon3 Fong1：高平调清晰，气质端正。', brotherText: '暂未发现与“恺”构成的自然正向词语。' },
  { char: '弘', group: '水', jyutping: 'Wang4', bazi: 28, meaning: 27, sound: 25, brother: 0, meaningText: '弘有弘扬、广大与宽厚之意，传统姓名学常作水性参考。', soundText: 'Au1 Zeon3 Wang4：尾音饱满，读感沉稳。', brotherText: '暂未发现与“恺”构成的自然正向词语。' },
  { char: '民', group: '水', jyutping: 'Man4', bazi: 27, meaning: 25, sound: 26, brother: 0, meaningText: '民有亲和、厚实与关怀众人之意，传统姓名学常作水性参考。', soundText: 'Au1 Zeon3 Man4：鼻尾柔和，整体亲切。', brotherText: '暂未发现与“恺”构成的自然正向词语。' },
  ...
  { char: '琛', group: '金', jyutping: 'Sam1', bazi: 28, meaning: 28, sound: 25, brother: 0, meaningText: '琛指珍宝，寓意珍贵、厚重与内涵，传统姓名学常作金性参考。', soundText: 'Au1 Zeon3 Sam1：高平调清楚，音色温润。', brotherText: '暂未发现与“恺”构成的自然正向词语。' },
  { char: '琦', group: '金', jyutping: 'Kei4', bazi: 27, meaning: 27, sound: 26, brother: 0, meaningText: '琦有美玉、奇秀与不凡之意，传统姓名学常作金性参考。', soundText: 'Au1 Zeon3 Kei4：尾音舒展，整体明亮。', brotherText: '暂未发现与“恺”构成的自然正向词语。' },
  { char: '琪', group: '金', jyutping: 'Kei4', bazi: 27, meaning: 28, sound: 26, brother: 0, meaningText: '琪指美玉，寓意珍美、纯正与才华，传统姓名学常作金性参考。', soundText: 'Au1 Zeon3 Kei4：长元音舒展，叫名清雅。', brotherText: '暂未发现与“恺”构成的自然正向词语。' },
  { char: '琨', group: '金', jyutping: 'Gwan1', bazi: 27, meaning: 26, sound: 25, brother: 0, meaningText: '琨为美玉，寓意温厚、坚实与光彩，传统姓名学常作金性参考。', soundText: 'Au1 Zeon3 Gwan1：高平调稳健，整体端正。', brotherText: '暂未发现与“恺”构成的自然正向词语。' },
  ...
  { char: '璞', group: '金', jyutping: 'Pok3', bazi: 27, meaning: 27, sound: 25, brother: 0, meaningText: '璞为未雕之玉，寓意质朴、潜能与真诚，传统姓名学常作金性参考。', soundText: 'Au1 Zeon3 Pok3：入声短促，读感干净。', brotherText: '暂未发现与“恺”构成的自然正向词语。' },
  { char: '瑄', group: '金', jyutping: 'Syun1', bazi: 27, meaning: 26, sound: 26, brother: 0, meaningText: '瑄为玉名，寓意温润、光洁与端方，传统姓名学常作金性参考。', soundText: 'Au1 Zeon3 Syun1：圆唇高平，音律清亮。', brotherText: '暂未发现与“恺”构成的自然正向词语。' },
  { char: '瑛', group: '金', jyutping: 'Jing1', bazi: 27, meaning: 27, sound: 26, brother: 0, meaningText: '瑛指玉的光彩，寓意英秀、明亮与出众，传统姓名学常作金性参考。', soundText: 'Au1 Zeon3 Jing1：高平调清晰，叫名明快。', brotherText: '暂未发现与“恺”构成的自然正向词语。' },
  { char: '瑀', group: '金', jyutping: 'Jyu5', bazi: 27, meaning: 26, sound: 25, brother: 0, meaningText: '瑀为玉名，寓意温厚、含蓄与有内在光泽，传统姓名学常作金性参考。', soundText: 'Au1 Zeon3 Jyu5：圆唇收尾柔和，整体温润。', brotherText: '暂未发现与“恺”构成的自然正向词语。' },
  ...
  { char: '玄', group: '水', jyutping: 'Jyun4', bazi: 28, meaning: 27, sound: 25, brother: 0, meaningText: '玄有深远、幽静与通达之意，传统姓名学常作水性参考。', soundText: 'Au1 Zeon3 Jyun4：鼻尾舒展，气质沉静。', brotherText: '暂未发现与“恺”构成的自然正向词语。' },
  { char: '墨', group: '水', jyutping: 'Mak6', bazi: 27, meaning: 28, sound: 25, brother: 0, meaningText: '墨有文墨、沉静与涵养之意，传统姓名学常作水性参考。', soundText: 'Au1 Zeon3 Mak6：入声收尾，读感稳重。', brotherText: '暂未发现与“恺”构成的自然正向词语。' },
  { char: '默', group: '水', jyutping: 'Mak6', bazi: 27, meaning: 26, sound: 24, brother: 0, meaningText: '默有沉静、专注与厚积之意，传统姓名学常作水性参考。', soundText: 'Au1 Zeon3 Mak6：短音沉着，风格内敛。', brotherText: '暂未发现与“恺”构成的自然正向词语。' },
  { char: '慧', group: '水', jyutping: 'Wai6', bazi: 28, meaning: 29, sound: 25, brother: 0, meaningText: '慧有聪慧、明辨与温柔之意，传统姓名学常作水性参考。', soundText: 'Au1 Zeon3 Wai6：尾调柔和，听感清雅。', brotherText: '暂未发现与“恺”构成的自然正向词语。' },
  { char: '敏', group: '水', jyutping: 'Man5', bazi: 27, meaning: 27, sound: 25, brother: 0, meaningText: '敏有敏锐、灵活与勤学之意，传统姓名学常作水性参考。', soundText: 'Au1 Zeon3 Man5：鼻尾轻柔，整体利落。', brotherText: '暂未发现与“恺”构成的自然正向词语。' },
  { char: '和', group: '水', jyutping: 'Wo4', bazi: 28, meaning: 29, sound: 26, brother: 0, meaningText: '和有和悦、和顺与包容之意，传统姓名学常作水性参考。', soundText: 'Au1 Zeon3 Wo4：圆唇舒展，叫名亲切。', brotherText: '暂未发现与“恺”构成的自然正向词语。' },
  { char: '飞', group: '水', jyutping: 'Fei1', bazi: 27, meaning: 27, sound: 27, brother: 0, meaningText: '飞有轻盈、远志与自由之意，传统姓名学常作水性参考。', soundText: 'Au1 Zeon3 Fei1：高平调明亮，读感轻快。', brotherText: '暂未发现与“恺”构成的自然正向词语。' },
  { char: '雷', group: '水', jyutping: 'Leoi4', bazi: 27, meaning: 25, sound: 25, brother: 0, meaningText: '雷有声势、行动与震发之意，传统姓名学常作水性参考。', soundText: 'Au1 Zeon3 Leoi4：圆唇鼻尾，辨识度高。', brotherText: '暂未发现与“恺”构成的自然正向词语。' },
  { char: '霭', group: '水', jyutping: 'Oi2', bazi: 27, meaning: 26, sound: 25, brother: 0, meaningText: '霭有云气、温柔与祥和之意，传统姓名学常作水性参考。', soundText: 'Au1 Zeon3 Oi2：开口上扬，音色柔和。', brotherText: '暂未发现与“恺”构成的自然正向词语。' },
  { char: '霈', group: '水', jyutping: 'Pui3', bazi: 27, meaning: 27, sound: 25, brother: 0, meaningText: '霈有大雨、恩泽与丰沛之意，传统姓名学常作水性参考。', soundText: 'Au1 Zeon3 Pui3：圆唇收尾，读感清楚。', brotherText: '暂未发现与“恺”构成的自然正向词语。' },
  { char: '震', group: '水', jyutping: 'Zan3', bazi: 27, meaning: 26, sound: 25, brother: 0, meaningText: '震有振作、声势与勇气之意，传统姓名学常作水性参考。', soundText: 'Au1 Zeon3 Zan3：短促有力，名字辨识度高。', brotherText: '暂未发现与“恺”构成的自然正向词语。' },
  { char: '雁', group: '水', jyutping: 'Ngaan6', bazi: 27, meaning: 27, sound: 24, brother: 0, meaningText: '雁有守序、远行与鸿志之意，传统姓名学常作水性参考。', soundText: 'Au1 Zeon3 Ngaan6：鼻音起首，风格沉稳。', brotherText: '暂未发现与“恺”构成的自然正向词语。' },
  { char: '雍', group: '水', jyutping: 'Jung1', bazi: 27, meaning: 27, sound: 25, brother: 0, meaningText: '雍有和谐、从容与大度之意，传统姓名学常作水性参考。', soundText: 'Au1 Zeon3 Jung1：高平调温厚，整体端正。', brotherText: '暂未发现与“恺”构成的自然正向词语。' },
  { char: '寒', group: '水', jyutping: 'Hon4', bazi: 27, meaning: 25, sound: 25, brother: 0, meaningText: '寒有清峻、坚忍与澄明之意，传统姓名学常作水性参考。', soundText: 'Au1 Zeon3 Hon4：长元音沉着，气质清冷。', brotherText: '暂未发现与“恺”构成的自然正向词语。' },
  { char: '冬', group: '水', jyutping: 'Dung1', bazi: 27, meaning: 26, sound: 25, brother: 0, meaningText: '冬有蓄养、沉静与坚韧之意，传统姓名学常作水性参考。', soundText: 'Au1 Zeon3 Dung1：高平调稳健，听感厚实。', brotherText: '暂未发现与“恺”构成的自然正向词语。' },
  { char: '北', group: '水', jyutping: 'Bak1', bazi: 26, meaning: 24, sound: 24, brother: 0, meaningText: '北有方向、坚定与守定之意，传统姓名学常作水性参考。', soundText: 'Au1 Zeon3 Bak1：入声短促，读感利落。', brotherText: '暂未发现与“恺”构成的自然正向词语。' },
  { char: '凌', group: '水', jyutping: 'Ling4', bazi: 27, meaning: 26, sound: 26, brother: 0, meaningText: '凌有凌云、超越与坚韧之意，传统姓名学常作水性参考。', soundText: 'Au1 Zeon3 Ling4：鼻尾清晰，音色清俊。', brotherText: '暂未发现与“恺”构成的自然正向词语。' },
  { char: '凝', group: '水', jyutping: 'Jing4', bazi: 27, meaning: 26, sound: 25, brother: 0, meaningText: '凝有凝聚、专注与沉静之意，传统姓名学常作水性参考。', soundText: 'Au1 Zeon3 Jing4：鼻尾舒展，整体稳重。', brotherText: '暂未发现与“恺”构成的自然正向词语。' },
  { char: '凛', group: '水', jyutping: 'Lam5', bazi: 26, meaning: 25, sound: 24, brother: 0, meaningText: '凛有严谨、清正与不屈之意，传统姓名学常作水性参考。', soundText: 'Au1 Zeon3 Lam5：鼻尾沉着，气质清峻。', brotherText: '暂未发现与“恺”构成的自然正向词语。' },
  { char: '牧', group: '水', jyutping: 'Muk6', bazi: 27, meaning: 26, sound: 25, brother: 0, meaningText: '牧有守护、涵养与从容之意，传统姓名学常作水性参考。', soundText: 'Au1 Zeon3 Muk6：入声收尾，读感干净。', brotherText: '暂未发现与“恺”构成的自然正向词语。' },
  { char: '帆', group: '水', jyutping: 'Faan4', bazi: 27, meaning: 27, sound: 26, brother: 0, meaningText: '帆有远行、方向与乘风而行之意，传统姓名学常作水性参考。', soundText: 'Au1 Zeon3 Faan4：长元音舒展，整体开阔。', brotherText: '暂未发现与“恺”构成的自然正向词语。' },
